<html>
	...
	<body>
	  <div class="container-fluid" >
		  ...
		  <div class="row" style="height:20px"></div>
		   ...
		   <div class="col-sm-4 w3-center w3-border-bottom w3-border-pink "><b  style="font-Size:25px;">Admission in University</b ></div>
		   <div class="col-sm-4"></div>
		</div>
	<div class="row" style="height:15px"></div>
	  ...
	  <div class="col-sm-10 w3-center"><a href="admission/ug.pdf">Undergraduates</a><br><br>
							 <a href="admission/ug.pdf">Postgraduates</a><br><br>
							 <a href="admission/ug.pdf">BSC</a><br><br>
							 <a href="admission/ug.pdf">MSC</a><br><br>
							 <a href="admission/ug.pdf">PHD</a><br><br>
	  </div>
	</div>
