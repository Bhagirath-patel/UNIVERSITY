	...
	<body>
	  <div class="container-fluid" >
		   ...
		   <div class="row" style="height:5px"></div>
			...
			<ul class="w3-navbar w3-text-white" style="background-color:darkslateblue; font-Size:12px">
				  ...
				  <li class="w3-dropdown-hover">
					<a href="#">PLACEMENT</a>
					<div class="w3-dropdown-content w3-brown w3-card-4 w3-border-bottom w3-border-white">
					  <a href="#">Dreams Offer</a>
					  <a href="#">Placement Records</a>
					  <a href="#">PAT Center</a>
					  <a href="#">Placement Consortium</a>
					</div>
				  </li>
				  <li class="w3-dropdown-hover">
		  ...
		  <div class="row" style="height:20px"></div>
		   ...
		   <div class="col-sm-4 w3-center w3-border-bottom w3-border-pink "><b  style="font-Size:25px;">Academics Center</b ></div>
		   <div class="col-sm-4"></div>
		</div>
