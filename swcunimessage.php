<html>
		  ...
		  <div class="row" style="background-color:darkslateblue; position:fixed; z-index:21212">
		   <div class="row" style="height:5px"></div>
			...
			<ul class="w3-navbar w3-text-white" style="background-color:darkslateblue; font-Size:20px">
				<li> <a href="index.php" class="w3-border-right w3-border-black">HOME</a> </li>
			...
			<div class="row" style="height:30px"> 
				...
				<div class="col-sm-4 w3-black">
							<a href="department.php"  style="font-Size:20px; text-decoration:none"> Department</a>	
				</div>
				<div class="col-sm-5  w3-black">
	...
	<!--problem-->
	    <div class="row w3-center"> <b class="w3-border-bottom w3-border-pink ">WEL-COME TO STUDENT WEL-FARE CENTER</b></div>
	        <div class="row">
			<?php
			$sr=0;
				if(isset($_GET["from"])){
				...
				if($r[1]!='university'){
					?>
						...
						<b class="w3-text-pink">&nbsp;&nbsp;&nbsp; <?=$r[3]?></b><br><br>
					<?php
					}
					else{
						?>
						<div class="col-sm-1"></div>
						<b class="w3-text-blue"><?=$r[3]?></b><br><br>
					<?php
					}
					}
			...
			<div class="panel panel-body">
			 <h3 class="w3-text-red w3-text-shadow" align="center">Your Problem Response Early Soon</h3><br>
		...
		<br>
		   ...
		   <div class="row">
			...
			<div class="col-sm-3 w3-card-12">
				...
				<div class="row" style="height:3px"></div>
				<div class="container"><b>Better laboratry And instument</b><br><br></div>
