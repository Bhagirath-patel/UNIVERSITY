	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
		...
		?>
			    ...
			    <form enctype="multipart/form-data" action="addresearchreg.php" method="POST">
			<div class="row">
			    <div class="col-sm-3">
					<label>Research Type</label>
				</div>
					<div class="col-sm-6">
						<select class="form-control" name="research" id="degree">
							<option>Select Research</option>
							<option>Academics Research</option>
							<option>Research Center</option>
							<option>Sponsored Research </option>
							<option>International Research</option>
						</div>
					</div>
				</div>
