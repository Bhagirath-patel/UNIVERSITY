	...
	?>
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
				...
				<br><br><a href="vcaddclg.php" class="fa fa-book" aria-hidden="true" style="text-decoration:none">
						  <b class="w3-text-Black" style="font-size:20px">&nbsp;&nbsp;&nbsp; Add College </b></a>
				<br><br><a href="vcallclg.php" class="fa fa-book" aria-hidden="true" style="text-decoration:none">
