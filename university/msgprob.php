	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
				...
				<br><br><a href="msgprob.php" class="fa fa-file-excel-o" aria-hidden="true" style="text-decoration:none">
				        <b class="w3-text-Black" style="font-size:20px">&nbsp;&nbsp;&nbsp;All message</b></a>
			...
			$sn=0;
			if(isset($_GET["succ"])){
				echo '<b class="w3-text-pink">'."message send".'</b><br>';
			}
			if(isset($_GET["dlt"])){
				echo '<b class="w3-text-pink">'."message delete".'</b><br>';
			}
				include("database.php");
				$rs=mysql_query("select * from problem_section where parent=1");
				while($r=mysql_fetch_array($rs)){
					...
					<div class="row">
					<div class="col-sm-3">
						<a href="allmsgprob.php?from=<?=$r[1]?>"><b class="w3-text-pink"><?=$r[1]?></b></a>
					</div>
					<div class="col-sm-1">
					<a href="#">delete</a>
					</div>
