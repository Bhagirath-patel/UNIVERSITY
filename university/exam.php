	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
			...
			<div class="col-sm-10">
					<div class="row">
						...
						<div class="col-sm-6">
							<?php
						   if(isset($_GET["suc"])){
								echo '<b class="w3-text-pink" style="font-size:25px;">'."Successfully Add Member".'</b>';
							}
							?>
							</div>
							<div class="col-sm-3"></div>
		    ...
		    <?php
				...
				$r=mysql_query("Select * from exam");
			...
			?>
		        ...
		        <div class="row">
				<div class="col-sm-3"></div>
				<div class="col-sm-6 w3-center"><a href="examaddmember.php" class="btn btn-lg btn-primary btn-block">Add New Member</a></div>
				<div class="col-sm-3"></div>
				</div>
			</div>
		</div>
