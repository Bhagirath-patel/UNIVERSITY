	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
			...
			<div class="row" style="font-size:23px">
				 ...
				 <div class="col-sm-6 w3-amber w3-card-12 w3-center"><b>All News</b></div>
				 <div class="col-sm-3"></div>
			</div>
			<div class="row" style="height:15px"></div>
			<?php
			   if(isset($_GET["suc"])){
	    echo '<b class="w3-text-pink" style="font-size:20px;">'."Successfully Add News".'</b>';
		}
		else if(isset($_GET["delete"])){
	        echo '<b class="w3-text-pink" style="font-size:20px;">'."Successfully Delete News".'</b>';
		}
		?>
		    ...
		    <?php
				...
				$r=mysql_query("Select * from news_section");
			...
			?>			
					<tr class="w3-hover-green">
					  ...
					  <td><b><a href="deletenews.php?news=<?=$rs[0]?>">Delete</a></b></td>
		        ...
		        <div class="row">
				<div class="col-sm-3"></div>
				<div class="col-sm-6 w3-center"><a href="addnews.php" class="btn btn-lg btn-primary btn-block">Add News</a></div>
				<div class="col-sm-3"></div>
				</div>
