	 ...
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
			...
			<div class="row" style="font-size:23px">
				 ...
				 <div class="col-sm-4 w3-amber w3-card-12"><b>All College in University</b></div>
				 <div class="col-sm-4"></div>
			</div>
			<div class="row" style="height:15px"></div>
			<?php
		...
		?>
			...
			?>
					<tr class="w3-hover-green">
					  ...
					  <td><b><a href="vcdeleteclg.php?name=<?=$rs[1]?>">Delete</a></b></td>
				...
				<div class="col-sm-6 w3-center"><a href="vcaddclg.php" class="btn btn-lg btn-primary btn-block">Add New College</a></div>
				<div class="col-sm-3"></div>
				</div>
			</div>
		</div>
