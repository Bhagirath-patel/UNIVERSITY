	...
	?>
	 <div class="container-fluid">
       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
			...
			<?php
			   if(isset($_GET["suc2"])){
	    echo '<b class="w3-text-pink" style="font-size:20px;">'."Successfully Add Branch".'</b>';
		}
		?>	
			<div class="row">
				<div class="well well-sm w3-text-pink"  align="center">
				<b style="text-decoration:underline; font-size:20px">-: Add Branch :-</b>
				</div>
			</div>
				<form  method="post" action="addbranchreg.php">
				<div class="row">
				   <div class="col-sm-3">
					<label>Degree:-</label>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input class="form-control" type="text" name="branch" required="required" placeholder="Branch Name">
					</div>
				</div>
					<br>
					<div class="w3-center">
