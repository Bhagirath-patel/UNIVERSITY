       ...
       <div class="col-sm-2" style="background-color:#FF7F50; height:620px;">
		...
		?>
		    ...
		    <?php
				...
				$r=mysql_query("Select * from result where flag='0'");
			...
			?>
					<tr class="w3-hover-green">
					  ...
					  <td><b><?=$rs[7]?></b></td>
					  <td><b><?=$rs[14]?></]?></b></td>
					  <td><b><a href="rstdelete.php?roll=<?=$rs[1]?>">Delete</a></b></td>
		        ...
		        <div class="row">
				<div class="col-sm-3"></div>
				<div class="col-sm-6 w3-center"><a href="examaddrst.php" class="btn btn-lg btn-primary btn-block">Add result </a></div>
				<div class="col-sm-3"></div>
				</div>
