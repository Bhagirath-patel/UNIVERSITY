...
<head>
        ...
        <title>Promlem Depart All Member</title>
		...
		<div class="row">
		 <div class="col-sm-2"></div>
           <div class="col-sm-8 w3-card-12 w3-border">			
			<form action="probaddmemberreg.php" method="post">
				<div class="row"  style="height:15px"></div>
				...
				<div class="row">
					...
					<div class="col-sm-10">
					     <select name="controller" id="control" class="form-control" required="required">
						    <option>Select Added Member</option>
						    <?php
							   include("database.php");
							  $r=mysql_query("select * from employee where department='problem' AND parent='child'");
