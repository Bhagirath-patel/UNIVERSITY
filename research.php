	...
	<body>
	  <div class="container-fluid" >
		  ...
		  <div class="row" style="height:20px"></div>
		   ...
		   <div class="col-sm-4 w3-center w3-border-bottom w3-border-pink "><b  style="font-Size:25px;">Research in University</b ></div>
		   <div class="col-sm-4"></div>
		</div>
	<div class="row" style="height:15px"></div>
	    <div class="row">
		   <div class="col-sm-1"></div>
		   <div class="col-sm-4 w3-center"> <button id="first"  onClick="change('first')">Academics Research</button><br><br>
											<button id="second" onClick="change('second')">Research Center</button><br><br>
											<button id="third"  onClick="change('third')">Sponsored Research</button><br><br>
											<button id="fourth" onClick="change('fourth')">International Research</button><br><br>
		   </div>
		  
					<div id="main">
						<h3>Academics Center</h3>
		            </div>
					<div id="firsts">
						<h3>Academics Center</h3>
		            </div>
