	...
	<div class="row">
		 <div class="col-sm-1"></div>
		    <div class="row w3-border-bottom w3-border-red">
			 <b> <i class="fa fa-plus-square-o" aria-hidden="true" style="font-Size:25px"></i></b><b class="w3-border-red  w3-text-pink" style="font-Size:25px">&nbsp;&nbsp;&nbsp;Syllabus</b>
			</div>
	</div>
	<div class="row" style="height:20px"></div>
	<div class="row">
		<div class="col-sm-3"></div>
		   <div class="col-sm-9">
		    ...
		    <?php
				...
				$sn=0;
				$r=mysql_query("Select * from branch");
			...
			?>			
					<tr class="w3-hover-green">
					  ...
					  <td><b><a href="university/timetable/<?=$rs[1]?><?=$rs[2]?>.pdf">Download</a></b></td>
